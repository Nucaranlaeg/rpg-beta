classes.monk = {
	...
	"Level 1": [
		"Ki - You have a pool of Ki you can use to power your abilities.  Your maximum Ki is equal to half your level rounded up plus your Wisdom modifier.  Gain the Ki Strike technique.",
		"Meditate - You can meditate, taking no actions for one round and regaining one Ki point.",
	],
	"Ki Techniques": [
		"Ki Strike - Spend one Ki point to deal an additional 1d6+Wis damage on all of your attacks until the start of your next turn.  You may activate this technique after you hit, but only once per round.",
		...
		"Stunning Strike - Spend one Ki point when you hit with an attack to force the target to make a Fortitude save with DC equal to 10 plus your Wisdom modifier.  On a failed save, that creature is stunned until the end of your next turn.  Either way, it is immune to your Stunning Strike until the end of your next turn.",
		...
		"Phantom Fist - Once per attack, spend one Ki point to reroll one attack die or all of your damage dice.",
	...
	"Monk": [
		...
		"Efficient Meridians - Each turn, the third Ki point you spend is refunded.",
	],
	"General": [
