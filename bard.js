classes.bard = {
	...
	"Songs": [
		...
		"Martyr's Cry - When an ally within 30 feet is wounded, you may choose to recieve all of the wounds from that attack instead.  If you do, your ally suffers none of the effects he would have suffered from the attack which caused the wound (beyond the damage recieved).  For instance, if he would have taken extra damage or had to make a save against an effect, neither of you take that extra damage or make a save.",
	],
	"Bard": [
	...
	"General": [
		"Echo - You may gain Advantage on a skill check if you see another creature succeed at it first.  The successful attempt must be in the last 10 minutes.",
	],
};
