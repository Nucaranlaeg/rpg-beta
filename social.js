ruleSections.alignment = [
	...
	{
		type: RULE_BLOCK.BODY,
		body: `In order to persuade someone or lie to them you will make a special skill check.  To your roll, add your Charisma modifier and the amount of relevant reputation to your check. Your DM makes the final call for which alignment you add, but your roleplay influences this determination. Your reputation goes before you: you don't add Glory when you're trying to convince someone that you're Good; you add Glory when you're trying to convince someone to agree with you because you're Good. This applies even in far-off lands you've never been to before, as your alignment has metaphysical reality.
		There is no target DC on this check.  Rather, determine your credibility by dividing the result of your check by 5 and rounding down.  NPCs will then modify this based on how much they like or trust you (-5 if they are your mortal enemy; +5 if they're your best friend) and this will influence their response.  While NPCs should be treated like people (so the result of a skill check doesn't force them to do anything in particular), nobody will listen to you if your final credibility is -1 or lower and you will almost always be heard out if your final credibility is 5 or higher.  Your DM might assign particular credibility targets to actions that NPCs might take.
