classes.barbarian = {
	...
	"Rage Modifier": [
		...
		"Reckless - Whenever you attack during this rage, you gain a bonus to your attack roll up to your Barbarian level.  Until the beginning of your next turn, you suffer a malus to your AC equal to the bonus.  If you use this feature multiple times in one turn, only the greatest malus applies.",
		...
		"Indomitable - You are immune to all mind-affecting status effects and non-damage effects from mind-affecting spells.  You have Advantage on saves against illusions.  You still take psychic damage (including from mind-affecting spells), but only half.  Allies within 30 feet of you have Advantage on saves against fear effects.",
		"Mighty - You gain +4 strength (in addition to the +4 strength you usually get for Rage), and Advantage on all strength-based skill checks.",
		"Triumphant - When a creature you have damaged in the last minute dies, heal hit points equal to your level and gain a +1 bonus to damage on your attacks.  This bonus stacks until your rage ends.",
	],
	"Barbarian": [
	...
	"General": [
		"Cleave - If you cause a creature to fall unconscious or die when you hit them with a melee weapon, you can immediately make an additional attack against a different creature within range with the same weapon.",
		"Muscled Around - When you deal damage with a melee attack with a heavy weapon to a creature no more than one size class greater than you, you may move that creature 5 feet in any direction that's not toward you.",
		"Fearsome Charge - You can charge by moving at least 20 feet in a straight line toward your target.  If your target is an enemy creature, you gain Advantage on all melee attacks against that creature until the end of your turn.  If it is an object, your melee attacks deal additional damage equal to one fifth of your speed to that object until the end of your turn.",
		...
		"Quick to the Fight - Your speed increases by 10 feet.  If you attack one or more enemies, your speed increases by another 10 feet until the end of your next turn (this does not stack).",
		"Invulnerable - While wearing light or no armour, reduce all damage you take by 3.",
		"Healthy - Your constitution score is increased by 3 for calculating whether you are wounded.",
		"Fearful Presence - Once per hour on your turn, you can intimidate creatures near you by your sheer presence.  This is a free action.  Enemy creatures within 30 feet who can see you must make a Wisdom save with DC 10 plus your strength modifier or become frightened for 1 round.",
