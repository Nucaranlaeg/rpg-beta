classes.fighter = {
	...
	"All": [
		...
		"Reaching any odd level in this class grants or improves the Melee Weapons skill or the Ranged Weapons skill.",
	],
	"Level 1": [
	...
	"Stance": [
		...
		"Bodyguard - When you enter this Stance, choose an adjacent creature.  That creature gains 2 AC, and whenever it would take damage, each of you instead takes half (it rounds up, you round down).  Neither you nor that creature gain any benefit from this Stance if you are not adjacent to that creature.  If you are mounted, you may select your mount.",
		...
		"Sentinel - While in this Stance, creatures entering spaces you threaten provoke attacks of opportunity from you (once per creature per turn).",
	],
	"General": [
