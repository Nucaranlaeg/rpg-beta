classes.archer = {
	...
	"Level 1": [
		"Archery Style - An archer knows one or more archery styles, and may use any one on a given turn.  Not all ranged weapons are suitable for all styles, and you must select an appropriate weapon for the style you use. Choose one style at level 1.",
	],
	"Archery Styles": [
