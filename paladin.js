classes.paladin = {
	...
	"Mount": [
		"Summon Mount - You may summon a mount appropriate to your size from the celestial realms.  It is more intelligent than a usual creature of that type, and understands you when you speak.  It also gains +1 to each of its stats, and maximum hit points equal to its Constitution score.  You may summon it as a standard action once per day, and it remains with you for up to 6 hours.  If it would fail a death saving throw, it instead returns to the celestial realms and you may not summon it again for 1 month.  You may use a standard action to return it to the celestial realms.\nYou summon the same creature each time, and it always is fully healed when you summon it.",
		"Improved Mount - Your mount gains an additional +1 to each of its stats and additional maximum hit points equal to its Constitution score plus your Paladin level.  If it is forced to return to the celestial realm, you may summon it again after 1 week.  Your mount's speed increases by 10 feet.",
