...
},
{
	...
	name: "Heaven's Wrath",
	requirements: [],
	effect: `You raise your arm to the sky and a bolt of lightning comes down and strikes near you.  Creatures within 5 feet of a point you specify take ${DAMAGE.Lightning}.  You do not have to be able to see the target, but you must be able to see a point within range above the target, and the target must not have a roof above it.`,
	manaEffect: `For each additional mana used, the spell deals an additional ${DAMAGE.Lightning}.`,
	spellData: {
		range: RANGE.Far,
		minMana: 3,
		school: SCHOOLS.Evocation,
...
},
{
	...
	name: "Taze",
	requirements: [],
	effect: `You bring forth a torrent of lightning, shocking your target.  The target takes ${DAMAGE.Lightning} and is incapacitated for the duration.  It may attempt the save again at the end of each of its turns.  If the target is touched by another creature (including by a melee attack), the other creature takes ${DAMAGE.Lightning}.`,
	manaEffect: `For each additional mana used, the spell deals an additional ${DAMAGE.Lightning}.`,
	spellData: {
		range: RANGE.Medium,
		minMana: 4,
...
},
{
	...
	name: "Consecrate",
	requirements: [],
	effect: `You bless the area in a 30 foot radius around a point you choose.  Undead in the area are weakened, suffering Disadvantage on their attack rolls and saving throws, and dealing 1 less damage on all of their attacks.  Animate Dead may not be cast in the area.`,
	manaEffect: `Each additional mana spent increases the damage reduction by 1.`,
	spellData: {
		range: RANGE.Medium,
		minMana: 3,
		school: SCHOOLS.Evocation,
